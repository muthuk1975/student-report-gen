  ...
  <div class="container-fluid h-100">
    <div class="row h-100">
      ...
      <div class="col-10 mt-3">
        ...
        <div class="row">
          <div class="col">
            <h1 class="title mb-3">Edit Staff</h1>
            ...
            <form action="" method="post">
              ...
              <div class="mb-3">
                ...
                <input class="form-control" id="staff_id" type="text" name="staff_id" value="<?php echo $row["staff_id"]; ?>" />
              </div>
              <div class="mb-3">
                <label for="staff_name" class="form-label">Staff Name</label>
                <input class="form-control" id="staff_name" type="text" name="staff_name" value="<?php echo $row["staff_name"]; ?>" />
              </div>
              <div class="mb-3">
                <label for="designation" class="form-label">Designation</label>
                <input class="form-control" id="designation" type="text" name="designation" value="<?php echo $row["designation"]; ?>" />
              </div>
              <div class="mb-3">
              ...
              <?php $subjects = json_decode($row["subject"], true); ?>
              <?php $subject1 = $subjects[0]; ?>
              <div class="mb-3 row subject_1">
                <div class="col">
                  <label for="scode_1" class="form-label">Subject Code 1</label>
                  <input class="form-control" readonly="true" id="scode_1" type="text" name="scode_1" value="<?php echo $subject1["scode"]; ?>" />
                </div>
                <div class="col">
                  <label for="sname_1" class="form-label">Subject Name 1</label>
                  <input class="form-control" readonly="true" id="sname_1" type="text" name="sname_1" value="<?php echo $subject1["sname"]; ?>" />
                </div>
                <div class="col">
                  <label for="bcode_1" class="form-label">Branch Code 1</label>
                  <input class="form-control" readonly="true" id="bcode_1" type="text" name="bcode_1" value="<?php echo $subject1["bcode"]; ?>" />
                </div>
                <div class="col">
                  <label for="sem_1" class="form-label">Semester 1</label>
                  <input class="form-control" readonly="true" id="sem_1" type="text" name="sem_1" value="<?php echo $subject1["sem"]; ?>" />
                </div>
                <div class="col">
                  <label for="year_1" class="form-label">Year 1</label>
                  <input class="form-control" readonly="true" id="year_1" type="text" name="year_1" value="<?php echo $subject1["year"]; ?>" />
                </div>
                <div class="col">
                  <label for="scheme_1" class="form-label">Scheme 1</label>
                  <input class="form-control" readonly="true" id="scheme_1" type="text" name="scheme_1" value="<?php echo $subject1["scheme"]; ?>" />
                </div>
                <div class="col">
                  <button class="btn btn-danger deleteSubject" data-id="1"><i class="bi bi-trash3"></i></button>
                </div>
              </div>
              <?php $subject1 = $subjects[1]; ?>
              <div class="mb-3 row subject_2">
                <div class="col">
                  <label for="scode_2" class="form-label">Subject Code 2</label>
                  <input class="form-control" readonly="true" id="scode_2" type="text" name="scode_2" value="<?php echo $subject1["scode"]; ?>" />
                </div>
                <div class="col">
                  <label for="sname_2" class="form-label">Subject Name 2</label>
                  <input class="form-control" readonly="true" id="sname_2" type="text" name="sname_2" value="<?php echo $subject1["sname"]; ?>" />
                </div>
                <div class="col">
                  <label for="bcode_2" class="form-label">Branch Code 2</label>
                  <input class="form-control" readonly="true" id="bcode_2" type="text" name="bcode_2" value="<?php echo $subject1["bcode"]; ?>" />
                </div>
                <div class="col">
                  <label for="sem_2" class="form-label">Semester 2</label>
                  <input class="form-control" readonly="true" id="sem_2" type="text" name="sem_2" value="<?php echo $subject1["sem"]; ?>" />
                </div>
                <div class="col">
                  <label for="year_2" class="form-label">Year 2</label>
                  <input class="form-control" readonly="true" id="year_2" type="text" name="year_2" value="<?php echo $subject1["year"]; ?>" />
                </div>
                <div class="col">
                  <label for="scheme_2" class="form-label">Scheme 2</label>
                  <input class="form-control" readonly="true" id="scheme_2" type="text" name="scheme_2" value="<?php echo $subject1["scheme"]; ?>" />
                </div>
                <div class="col">
              ...
              <div class="mb-3 row subject_3">
                <div class="col">
                  ...
                  <input class="form-control" readonly="true" id="scode_3" type="text" name="scode_3" value="<?php echo $subject1["scode"]; ?>" />
                </div>
                <div class="col">
                  <label for="sname_3" class="form-label">Subject Name 3</label>
                  <input class="form-control" readonly="true" id="sname_3" type="text" name="sname_3" value="<?php echo $subject1["sname"]; ?>" />
                </div>
                <div class="col">
                  <label for="bcode_3" class="form-label">Branch Code 3</label>
                  <input class="form-control" readonly="true" id="bcode_3" type="text" name="bcode_3" value="<?php echo $subject1["bcode"]; ?>" />
                </div>
                <div class="col">
                  <label for="sem_3" class="form-label">Semester 3</label>
                  <input class="form-control" readonly="true" id="sem_3" type="text" name="sem_3" value="<?php echo $subject1["sem"]; ?>" />
                </div>
                <div class="col">
                  <label for="year_3" class="form-label">Year 3</label>
                  <input class="form-control" readonly="true" id="year_3" type="text" name="year_3" value="<?php echo $subject1["year"]; ?>" />
                </div>
                <div class="col">
                  <label for="scheme_3" class="form-label">Scheme 3</label>
                  <input class="form-control" readonly="true" id="scheme_3" type="text" name="scheme_3" value="<?php echo $subject1["scheme"]; ?>" />
                </div>
                <div class="col">
              ...
              <div class="mb-3 row subject_4">
                <div class="col">
                  ...
                  <input class="form-control" readonly="true" id="scode_4" type="text" name="scode_4" value="<?php echo $subject1["scode"]; ?>" />
                </div>
                <div class="col">
                  <label for="sname_4" class="form-label">Subject Name 4</label>
                  <input class="form-control" readonly="true" id="sname_4" type="text" name="sname_4" value="<?php echo $subject1["sname"]; ?>" />
                </div>
                <div class="col">
                  <label for="bcode_4" class="form-label">Branch Code 4</label>
                  <input class="form-control" readonly="true" id="bcode_4" type="text" name="bcode_4" value="<?php echo $subject1["bcode"]; ?>" />
                </div>
                <div class="col">
                  <label for="sem_4" class="form-label">Semester 4</label>
                  <input class="form-control" readonly="true" id="sem_4" type="text" name="sem_4" value="<?php echo $subject1["sem"]; ?>" />
                </div>
                <div class="col">
                  <label for="year_4" class="form-label">Year 4</label>
                  <input class="form-control" readonly="true" id="year_4" type="text" name="year_4" value="<?php echo $subject1["year"]; ?>" />
                </div>
                <div class="col">
                  <label for="scheme_4" class="form-label">Scheme 4</label>
                  <input class="form-control" readonly="true" id="scheme_4" type="text" name="scheme_4" value="<?php echo $subject1["scheme"]; ?>" />
                </div>
                <div class="col">
                  <label>&nbsp;</label><br />
