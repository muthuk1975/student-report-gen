...
if(isset($_REQUEST["id"])){
  ...
  if(isset($_POST['scode'])){
    $query = "UPDATE `sub_details` SET `scode` = '".$_POST['scode']."', `sname` = '".$_POST['sname']."', `bcode` = '".$_POST['bcode']."', `sem` = '".$_POST['sem']."', `year` = '".$_POST['year']."', `scheme` = '".$_POST['scheme']."' WHERE `id` = '".$_REQUEST['id']."'";
    mysqli_query($con, $query);
    $successMessage = "Record Added";
  }
  $select = "SELECT * FROM `sub_details` WHERE `id` = '".$_REQUEST['id']."'";
          ...
          <div class="col">
            ...
            <form action="" method="post">
              ...
              <div class="mb-3">
                ...
                <input class="form-control" id="scode" type="text" name="scode" value="<?php echo $row["scode"]; ?>" />
              </div>
              <div class="mb-3">
                <label for="sname" class="form-label">Subject Name</label>
                <input class="form-control" id="sname" type="text" name="sname" value="<?php echo $row["sname"]; ?>" />
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <select class="form-control" id="sem" name="sem">
                  ...
                  <option value="3"<?php if($row["sem"] == "3"){echo " selected";} ?>>3</option>
                  <option value="4"<?php if($row["sem"] == "4"){echo " selected";} ?>>4</option>
              ...
              <div class="mb-3">
                ...
                <select class="form-control" id="scheme" name="scheme">
                  <option value="">Choose</option>
                  <option value="L"<?php if($row["scheme"] == "L"){echo " selected";} ?>>L</option>
                  <option value="M"<?php if($row["scheme"] == "M"){echo " selected";} ?>>M</option>
                  <option value="N"<?php if($row["scheme"] == "N"){echo " selected";} ?>>N</option>
                </select>
              </div>
              <?php } ?>
              <div>
